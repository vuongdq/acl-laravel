...
--
-- Host: localhost
-- Generation Time: Sep 16, 2015 at 08:14 PM
...
('2015_09_16_112300_create_cate_type_table', 4);
...
ALTER TABLE `articles`
  ...
  ADD KEY `articles_articles_id_foreign` (`articles_id`);
...
--
ALTER TABLE `articles`
  ADD CONSTRAINT `articles_articles_id_foreign` FOREIGN KEY (`articles_id`) REFERENCES `articles_types` (`id`) ON DELETE CASCADE,
